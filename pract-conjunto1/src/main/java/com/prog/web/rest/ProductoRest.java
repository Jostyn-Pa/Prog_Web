...
import com.prog.web.servicios.inter.ProductoServicioInter;
...
public class ProductoRest {
    ...
    public Response create(Producto producto) {
        Producto p1 = productoServicioInter.create(producto);
    ...
    public Response update(@PathParam("id")Integer id, Producto producto) {
        return productoServicioInter.update(id, producto)
    ...
    @GET
    @Path("/search")
    public Response query(@QueryParam("nombre")String nombre, @QueryParam("minPrecio")Double minPrecio, @QueryParam("maxPrecio")Double maxPrecio){
        var obj = productoServicioInter.query(nombre, minPrecio, maxPrecio);
        return Response.ok(obj).build();
    }
}
