...
public class LibroServicioImpl implements LibroServicioInter {
    ...
    @Override
    public List<Libro> findByTituloAndMinPrecioAndMaxPrecioAndCategoria(String titulo, Double minPrecio, Double maxPrecio, String categoria) {
        var obj = libroRepository.findByTituloAndMinPrecioAndMaxPrecioAndCategoria(
    ...
    @Override
    public List<Libro> findByAutorId(Integer id) {
