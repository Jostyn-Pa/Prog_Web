...
@ApplicationScoped
public class OrdenCompraServicioImpl implements OrdenCompraServicioInter {

    private final OrdenCompraRepository ordenCompraRepository;

    @Inject
    public OrdenCompraServicioImpl(OrdenCompraRepository ordenCompraRepository) {
    ...
    @Override
    public List<OrdenCompra> findByClienteId(Integer id) {
        return ordenCompraRepository.findByClienteId(id);
    }
}
